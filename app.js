...
function sum(a,b){ //eslint-disable-line
  var sumOfArguments = a + b;

  var concatenateArray = 'The sum of ' + a + ' and ' + b + ' is ' + sumOfArguments + '.';

  var arrayReturn = [sumOfArguments, concatenateArray];
...
function multiply(a,b){ //eslint-disable-line
  var multiplyArguments = a * b;

  var addingArguments = 'The product of ' + a + ' and ' + b + ' is ' + multiplyArguments + '.';

  var returnArray = [multiplyArguments, addingArguments];
